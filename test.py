...
def get_country_data():
  url = "http://liansai.500.com/index.php?c=teams&a=ajax_fixture&records=100&8&hoa=0&tid=28"
...
def get_request(url, team):
  ...
  file_ori = open('/Users/francis/Documents/worldCup/test.json','r+')
  file_ori.write(resp)
  file_ori.close()
...
def create_file():
  file_path = '/Users/francis/Documents/worldCup/test2.json'
